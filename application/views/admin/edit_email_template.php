...
<ol class="breadcrumb">
  ...
  <li><a href="<?php echo site_url("backend/admin/email_templates") ?>"><?php echo lang("ctn_3") ?></a></li>
...
<?php echo form_open(site_url("backend/admin/edit_email_template_pro/" . $email_template->ID), array("class" => "form-horizontal")) ?>
