...
<ol class="breadcrumb">
  ...
  <li><a href="<?php echo site_url("backend/admin") ?>"><?php echo lang("ctn_1") ?></a></li>
  <li><a href="<?php echo site_url("backend/admin/user_groups") ?>"><?php echo lang("ctn_15") ?></a></li>
...
<?php echo form_open(site_url("backend/admin/edit_group_pro/" . $group->ID), array("class" => "form-horizontal")) ?>
