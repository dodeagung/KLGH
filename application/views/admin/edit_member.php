...
<ol class="breadcrumb">
  ...
  <li><a href="<?php echo site_url("backend/admin/members") ?>"><?php echo lang("ctn_21") ?></a></li>
...
<?php echo form_open_multipart(site_url("backend/admin/edit_member_pro/" . $member->ID), array("class" => "form-horizontal")) ?>
...
<div class="form-group">
        ...
        <div class="col-md-9">
            <?php foreach($user_groups->result() as $r) : ?>
                <p><a href="<?php echo site_url("backend/admin/view_group/" . $r->groupid) ?>"><?php echo $r->name ?></a></p>
            <?php endforeach; ?>
        </div>
</div>
<div class="form-group">
