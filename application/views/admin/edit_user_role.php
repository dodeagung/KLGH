...
<ol class="breadcrumb">
  ...
  <li><a href="<?php echo site_url("backend/admin") ?>"><?php echo lang("ctn_1") ?></a></li>
  <li><a href="<?php echo site_url("backend/admin/user_roles") ?>"><?php echo lang("ctn_316") ?></a></li>
...
<?php echo form_open(site_url("backend/admin/edit_user_role_pro/" . $role->ID), array("class" => "form-horizontal")) ?>
