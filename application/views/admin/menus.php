...
<div class="db-header clearfix">
    ...
    <div class="db-header-extra"> <a href="<?php echo site_url("backend/admin/add_menu") ?>" class="btn btn-primary btn-sm"><?php echo lang("ctn_380") ?></a>
</div>
</div>
...
<tr><td><?php echo $r->name ?></td><td><a href="<?php echo site_url("backend/edit_menu/" . $r->ID) ?>" class="btn btn-warning btn-xs" data-toggle="tooltip" data-placement="bottom" title="<?php echo lang("ctn_55") ?>"><span class="glyphicon glyphicon-cog"></span></a> <a href="<?php echo site_url("backend/delete_menu/" . $r->ID . "/" . $this->security->get_csrf_hash()) ?>" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="bottom" title="<?php echo lang("ctn_57") ?>"><span class="glyphicon glyphicon-trash"></span></a></td></tr>
<?php endforeach; ?>
</table>
