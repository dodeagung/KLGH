...
<tr><td><?php echo $r->name ?></td><td><?php echo number_format($r->cost, 2) ?></td><td><?php echo $r->days ?></td><td><?php echo $r->sales ?></td><td><a href="<?php echo site_url("backend/admin/edit_payment_plan/" . $r->ID) ?>" class="btn btn-warning btn-xs" title="<?php echo lang("ctn_55") ?>"><span class="glyphicon glyphicon-cog"></span></a> <a href="<?php echo site_url("backend/admin/delete_payment_plan/" . $r->ID . "/" . $this->security->get_csrf_hash()) ?>" class="btn btn-danger btn-xs" title="<?php echo lang("ctn_57") ?>"><span class="glyphicon glyphicon-trash"></span></a></td></tr>
<?php endforeach; ?>
</table>
...
<div class="modal fade" id="planModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php echo form_open(site_url("backend/add_payment_plan"), array("class" => "form-horizontal")) ?>
