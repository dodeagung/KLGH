...
<ol class="breadcrumb">
  ...
  <li><a href="<?php echo site_url("backend/user_groups") ?>"><?php echo lang("ctn_15") ?></a></li>
...
<tr><td><?php echo $r->username ?></td><td><?php echo $r->name ?></td><td><a href="<?php echo site_url("backend/remove_user_from_group/" . $r->userid . "/" . $r->groupid . "/" . $this->security->get_csrf_hash()) ?>" class="btn btn-danger btn-xs"><?php echo lang("ctn_130") ?></a></td></tr>
<?php endforeach; ?>
</table>
...
<div class="modal fade" id="memberModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php echo form_open(site_url("backend/add_user_to_group_pro/" . $group->ID), array("class" => "form-horizontal")) ?>
