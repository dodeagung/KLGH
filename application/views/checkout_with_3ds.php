...
<head>
	...
	<!-- Include PaymentAPI  -->
	<link rel="stylesheet" href="<?php echo base_url();?>theme_costume/css/css_mt/jquery.fancybox.css">
</head>
<body>
	<script type="text/javascript" src="https://api.sandbox.veritrans.co.id/v2/assets/js/veritrans.min.js"></script>
	<script src="//ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url();?>theme_costume/js/js_mt/jquery.fancybox.pack.js"></script>

	<h1>Checkout</h1>
	<form action="<?php echo site_url()?>backend/midtrans/vtdirect/vtdirect_cc_charge" method="POST" id="payment-form">
		<fieldset>
