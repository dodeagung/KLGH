...
<div class="db-header clearfix">
    ...
    <div class="db-header-extra"> <a href="<?php echo site_url("backend/content/add_page") ?>" class="btn btn-primary btn-sm"><?php echo lang("ctn_400") ?></a>
    </div>
</div>

<div class="panel panel-default">
<div class="panel-body">
<?php echo form_open_multipart(site_url("backend/content/add_page_pro"), array("class" => "form-horizontal")) ?>
