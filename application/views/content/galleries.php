...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
        <ul class="dropdown-menu small-text" style="min-width: 90px !important; left: -90px;">
          ...
          <li><a href="#" onclick="change_search(4)"><span class="glyphicon glyphicon-ok no-display" id="summary-exact"></span> <?php echo lang("ctn_498") ?></a></li></a></li>
    ...
    <a href="<?php echo site_url("backend/content/add_gallery") ?>" class="btn btn-primary btn-sm"><?php echo lang("ctn_495") ?></a>
    </div>
</div>
   ...
   var st = $('#search_type').val();
    var table = $('#content-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("backend/content/content_gallery") ?>",
            type : 'GET',
            data : function ( d ) {
