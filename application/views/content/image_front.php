...
<div class="db-header clearfix">
    <div class="page-header-title"> <span class="glyphicon glyphicon-file"></span> <?php echo lang("ctn_505") ?></div>
   ...
   var st = $('#search_type').val();
    var table = $('#content-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("backend/content/content_image_front") ?>",
            type : 'GET',
            data : function ( d ) {
