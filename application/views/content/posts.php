...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
    ...
    <a href="<?php echo site_url("backend/content/add_post") ?>" class="btn btn-primary btn-sm"><?php echo lang("ctn_491") ?></a>
    </div>
</div>
   ...
   var st = $('#search_type').val();
    var table = $('#content-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("backend/content/content_post") ?>",
            type : 'GET',
            data : function ( d ) {
