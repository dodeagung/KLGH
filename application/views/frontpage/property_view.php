          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <span class="button-action"> <a class="button solid  as-button " href="#header">BOOK NOW</a> </span>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center">
          <p class="above-header">Our Room</p>
          <h2>Get To Know our room</h2>
          <p>with unique Bed & Breakfast tourism facility situated on the magnificent Mediterranean sea shores, prepared to welcome tranquility seeking tourists all year long. Click the images below to see more</p>
        </div>
        <div class="col-md-12"> 
