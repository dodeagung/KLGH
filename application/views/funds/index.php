...
<p class="align-center"><img src="<?php echo base_url() ?>/images/paypal.png"></p>
		...
		<form method="post" action="https://www.paypal.com/cgi-bin/webscr" accept-charset="UTF-8" class="form-inline">
				...
				<input type="hidden" name="notify_url" value="<?php echo site_url("backend/IPN/process2") ?>" />
				<input type="hidden" name="return" value="<?php echo site_url("backend/funds") ?>" />
				<input type="hidden" name="cancel_return" value="<?php echo site_url("backend/funds") ?>" />
