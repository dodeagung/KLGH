...
<p class="category-title"><a href="<?php echo site_url("backend/gallery/view_cat/" . $r->ID) ?>"><?php echo $r->name ?></a></p>
<p><?php echo $r->description ?></p>
<hr>
<p><div class="circle-buttons"><a href="<?php echo site_url("backend/gallery/view_cat/" . $r->ID) ?>"><span class="glyphicon glyphicon-list"></span></a></div></p>
</div>
</div>
<?php endforeach; ?>
</div>
