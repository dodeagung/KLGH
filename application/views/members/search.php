...
<ol class="breadcrumb">
  <li><a href="<?php echo site_url("backend/") ?>"><?php echo lang("ctn_189") ?></a></li>
  <li><a href="<?php echo site_url("backend/members") ?>"><?php echo lang("ctn_189") ?></a></li>
...
<?php foreach($members->result() as $r) : ?>
	...
	?>
<tr><td><a href="<?php echo site_url("backend/profile/view/" . $r->username) ?>"><?php echo $r->username ?></a></td><td><?php echo $r->first_name . " " . $r->last_name ?></td><td><?php echo $this->common->get_user_role($r) ?></td><td><?php echo date($this->settings->info->date_format, $r->joined) ?></td><td><?php echo $provider ?></td></tr>
<?php endforeach; ?>
