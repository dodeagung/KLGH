...
<div class="login-page">
    		...
    		<?php echo form_open(site_url("backend/register"), array("class" => "form-horizontal")) ?>
...
<?php endif; ?>
		  		...
		  		<p class="decent-margin"><a href="<?php echo site_url("backend/login") ?>" class="btn btn-success form-control" ><?php echo lang("ctn_223") ?></a></p>
