...
<ol class="breadcrumb">
  ...
  <li><a href="<?php echo site_url("backend/user_settings") ?>"><?php echo lang("ctn_224") ?></a></li>
...
<hr>
	...
	<div class="panel panel-default">
  	...
  	<?php echo form_open(site_url("backend/user_settings/change_password_pro"), array("class" => "form-horizontal")) ?>
