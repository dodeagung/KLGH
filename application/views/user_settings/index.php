...
<div class="db-header clearfix">
    ...
    <div class="db-header-extra"> <a href="<?php echo site_url("backend/user_settings/change_password") ?>" class="btn btn-primary btn-sm"><?php echo lang("ctn_225") ?></a>
</div>
</div>
...
<?php echo form_open_multipart(site_url("backend/user_settings/pro"), array("class" => "form-horizontal")) ?>
		<div class="form-group">
	    <label for="inputEmail3" class="col-sm-2 control-label"><?php echo lang("ctn_228") ?></label>
	    <div class="col-sm-10">
	      <a href="<?php echo site_url("backend/profile/view/" . $this->user->info->username) ?>"><?php echo $this->user->info->username ?></a>
	    </div>
	</div>
	<?php if($this->settings->info->payment_enabled) : ?>
		<div class="form-group">
		    ...
		    <div class="col-sm-10">
		    <p><?php echo lang("ctn_248") ?>: <?php echo number_format($this->user->info->points,2) ?>. <a href="<?php echo site_url("backend/funds") ?>"><?php echo lang("ctn_245") ?></a></p>
			...
			<?php endif; ?>
			<p><a href="<?php echo site_url("backend/funds/plans") ?>"><?php echo lang("ctn_285") ?></a></p>
		    </div>
		</div>
	<?php endif; ?>
	<div class="form-group">
